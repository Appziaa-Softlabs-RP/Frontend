    ...
    return (
        <React.Fragment>
            <div className={`${styles.cartSummryBox} col-12 d-inline-flex flex-column`}>
                <h1 className={`${styles.cartTitle} col-12 p-3 d-inline-flex`}>My Cart ()</h1>
                    ...
                    {cartData?.length > 0 && cartData?.map((item, idx) => {
                        ...
                        <div className="col-12 d-inline-flex align-items-center">
                            ...
                            <div className="col-2 d-inline-flex align-items-center">
                                <span onClick={(e) => updateProdQty()} className={`${styles.decrease_btn} ${styles.minusIcon} d-inline-flex align-items-center justify-content-center`}>-</span>
                                ...
                                <span onClick={(e) => updateProdQty()} className={`${styles.increase_btn} ${styles.plusIcon} d-inline-flex align-items-center justify-content-center`}>+</span>
                            </div>
                        </div>
                        );
                    })}
