              ...
              <div className={`${styles.headerInnerRow} col-12 d-inline-flex align-items-stretch gap-3`}>
                ...
                <div className="d-inline-flex align-items-stretch justify-content-end gap-5">
                  ...
                  {userInfo && userInfo?.customer_id !== '' ? (
                    <div className={`${styles.supportDrop} ${styles.userNavBox} d-inline-flex d-inline-flex align-items-center gap-2 position-relative`} role="button">
                      <UserIcon color="#FFF" />
                      <span className={`${styles.supportText} d-inline-flex`}>{userInfo.name}</span>
                      <DownArrowIcon color="#FFF" role="button" />
                      <div className={`${styles.userMenuList} d-inline-flex flex-column gap-1 position-absolute`}>
                        <span role="button" className={`${styles.subMenuName} col-12 align-items-center px-3 d-inline-flex py-2`} onClick={() => navigate('/my-address')}>My Address</span>
                        <span role="button" className={`${styles.subMenuName} col-12 align-items-center px-3 d-inline-flex py-2`} onClick={() => navigate('/my-account')}>My Account</span>
                        <span role="button" className={`${styles.subMenuName} col-12 align-items-center px-3 d-inline-flex py-2`} onClick={() => navigate('/my-orders')}>My Orders</span>
                        <span role="button" className={`${styles.subMenuName} col-12 align-items-center px-3 d-inline-flex py-2`}>Logout</span>
                      </div>
                    </div>
                  ) : (
