                ...
                <div className="container">
                    ...
                    <p className="c6">
                        <span className="c4">
                            ...
                            TaraToy.in, covering important aspects for an online toy store
                            operating in India.
                        </span>
                    </p>
                    <p className="c6">
                        <span className="c1">TaraToy.in Terms &amp; Conditions</span>
                    </p>
                    <p className="c6">
                    ...
                    <p className="c6">
                        <span className="c2">
                            Welcome to TaraToy.in (&quot;the Site&quot;). These Terms &amp;
                            Conditions (&quot;Terms&quot;) govern your use of the Site and the
                            purchase of products from TaraToy.
                        </span>
                    ...
                    <ul className="c10 lst-kix_ui22japon8s6-0 start">
                        <li className="c0 li-bullet-0">
                            <span className="c4">
                                ...
                                images, and software is the property of TaraToy or its licensors
                    ...
                    <ul className="c10 lst-kix_28a2ovzdh5yk-0 start">
                        <li className="c0 li-bullet-0">
                            <span className="c4">
                                You agree to indemnify and hold TaraToy harmless from any claims
                                or damages that arise from your use of the Site or your
                    ...
                    <ul className="c10 lst-kix_pcvdgx2icjy4-0 start">
                        ...
                        <li className="c0 li-bullet-0">
                            ...
                            <span className="c8">&nbsp;</span>
                            <span className="c14">{enviroment.STORE_ADDRESS}, India, </span>
                        </li>
                    </ul>
                    <p className="c6">
                        <span className="c1">
                            By using the TaraToy.in website, you acknowledge and agree to
