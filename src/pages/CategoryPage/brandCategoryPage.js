    ...
    <React.Fragment>
      <Helmet>
        ...
        <title>
          ...
          &nbsp;merchandise at TaraToy.in, their official store!
        </title>
        <meta
          name="description"
          content="From action figures to musical instruments, TaraToy.in has all the official <Band Name> toys to inspire creativity and rockstar dreams!"
        />
      </Helmet>
      {windowWidth === "mobile" ? (
