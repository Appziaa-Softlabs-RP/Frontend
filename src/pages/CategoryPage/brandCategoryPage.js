    ...
    <React.Fragment>
      <Helmet>
        ...
        <title>
          ...
          &nbsp;merchandise at pujapath.co.in, their official store!
        </title>
        <meta
          name="description"
          content="From action figures to musical instruments, pujapath.co.in has all the official <Band Name> toys to inspire creativity and rockstar dreams!"
        />
      </Helmet>
      {windowWidth === "mobile" ? (
