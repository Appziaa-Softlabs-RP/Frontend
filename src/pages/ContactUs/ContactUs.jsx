                ...
                <div className="mt-5 p-4 bg-light rounded">
                    <div className="row" style={{
                        ...
                        >
                            ...
                            <p><strong>Email:</strong> <br /><a href={`mailto:${enviroment.EMAIL_ADDRESS}`} style={{
                                textDecoration: 'none',
                                color: 'inherit',
                            }}><span style={{ color: 'black', fontSize: '15px' }}>{enviroment.EMAIL_ADDRESS}</span></a>
                            </p>
                        </div>
                        {
                        ...
                        >
                            ...
                            <p style={{
                                ...
                                style={{
                                    textDecoration: 'none',
                                    color: 'inherit'
                                }}><span style={{ color: 'black', fontSize: '15px' }}>{enviroment.PHONE_NUMBER}</span></a>
                            </p>
                        </div>
                    </div>
                </div>
