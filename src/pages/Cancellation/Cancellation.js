        ...
        <React.Fragment>
            ...
            <div className="min-vh-100 col-12 d-inline-flex flex-column">
                <div className="container">
                    ...
                    <p className="c6">
                        <span className="c7">Sangpriya Cancellation Policy</span>
                    </p>
                    <p className="c6">
                    ...
                    <p className="c6">
                        <span className="c8">Sangpriya offers a </span>
                    ...
                    <ul className="c10 lst-kix_ja24afuyk4no-0 start">
                        <li className="c0 li-bullet-0">
                            <span className="c4">
                                ...
                                Sangpriya. Items purchased from other retailers or through
