        ...
        <React.Fragment>
            ...
            <div className="min-vh-100 col-12 d-inline-flex flex-column my-5">
                <div className="container">
                    <h1>Return Policy</h1>
                    <p className="c6">
                        <span className="c7">TaraToy Return Policy</span>
                    </p>
                    <p className="c6">
                    ...
                    <p className="c6">
                        <span className="c8">TaraToy offers a </span>
                    ...
                    <ul className="c10 lst-kix_cb5fqzi5fw09-0">
                        <li className="c0 li-bullet-0">
                            ...
                            <span className="c14 c18">
                                {enviroment.STORE_ADDRESS}. India,{" "}
                            </span>
                            <span className="c4">
                    ...
                    <ul className="c10 lst-kix_ja24afuyk4no-0 start">
                        <li className="c0 li-bullet-0">
                            <span className="c4">
                                This return policy applies only to purchases made from TaraToy.
                                Items purchased from other retailers or through third-party
                                marketplaces may have different return policies.
                            </span>
                        </li>
                        <li className="c0 li-bullet-0">
                            <span className="c4">
